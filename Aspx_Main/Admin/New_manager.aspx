<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Manager.master" AutoEventWireup="true" CodeFile="New_manager.aspx.cs" Inherits="Aspx_Main_Admin_New_manager" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <body>
        ...
        <div class="content-wrapper">
            <div class="container-fluid">
                <h1 class="mt-4"  style="position:relative;top:-25px">新闻管理</h1>
                <asp:Button ID="btnAddNews" runat="server" Text="添加新闻" cssClass="btnAddNews" OnClick="btnAddNews_Click"/>
                <div class="row">
                    <div class="col-lg-6">
                                ...
                                <div class="table-responsive">
                                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="id" DataSourceID="SqlDataSource1" BorderColor="#13619c" BorderStyle="Solid" BorderWidth="5px" CellPadding="4" CellSpacing="4" ForeColor="black" HorizontalAlign="Center" CssClass="auto-style1" Height="366px" Width="1141px">
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="xinwen_content" HeaderText="内容" SortExpression="xinwen_content" />
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Farmers_dbConnectionString %>" DeleteCommand="DELETE FROM [xinwen_info] WHERE [id] = @id" InsertCommand="INSERT INTO [xinwen_info] ([username], [password], [keys]) VALUES (@username, @password, @keys)" SelectCommand="SELECT * FROM [xinwen_info]" UpdateCommand="UPDATE [xinwen_info] SET [title] = @title, [xinwen_content] = @xinwen_content, [submitdate] = @submitdate,[publisher] = @publisher WHERE [id] = @id">
                                        <DeleteParameters>
