<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Manager.master" AutoEventWireup="true" CodeFile="User_manager.aspx.cs" Inherits="Aspx_Main_Admin_manager" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <body>
        ...
        <div class="content-wrapper">
            <div class="container-fluid">
                <h1 class="mt-4" style="position: relative; top: -25px">用户管理</h1>
                <div class="row">
                    <div class="col-lg-6">
                        <div class="card mb-4" style="width: 1440px">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:Farmers_dbConnectionString %>" SelectCommand="SELECT * FROM [User_info]"></asp:SqlDataSource>
                                    ...
                                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="id" DataSourceID="SqlDataSource1" BorderColor="#13619c" BorderStyle="Solid" BorderWidth="5px" CellPadding="4" CellSpacing="4" ForeColor="black" HorizontalAlign="Center" CssClass="auto-style1" Height="366px" Width="825px" OnRowCommand="gly">
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="keys" HeaderText="权限分组" SortExpression="keys" />
                                            <asp:BoundField DataField="permission" HeaderText="发帖权限" SortExpression="permission" />


                                            <asp:CommandField HeaderText="编辑" ShowEditButton="True" />
                                            <asp:CommandField HeaderText="删除" ShowDeleteButton="True" />
                                            <asp:ButtonField Text="设置为管理员" HeaderText="设置为管理员" CommandName="gly" />
                                            <asp:ButtonField Text="取消管理员" HeaderText="取消为管理员" CommandName="gly1" />


                                        </Columns>
                                    </asp:GridView>
                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Farmers_dbConnectionString %>" DeleteCommand="DELETE FROM [User_info] WHERE [id] = @id" InsertCommand="INSERT INTO [User_info] ([username], [password], [keys]) VALUES (@username, @password, @keys)" SelectCommand="SELECT * FROM [User_info]" UpdateCommand="UPDATE [User_info] SET [username] = @username, [password] = @password, [keys] = @keys WHERE [id] = @id">
                                        <DeleteParameters>
