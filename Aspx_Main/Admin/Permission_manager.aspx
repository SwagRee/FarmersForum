<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Manager.master" AutoEventWireup="true" CodeFile="Permission_manager.aspx.cs" Inherits="Aspx_Main_Admin_Permission_manager" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <body>
        ...
        <div class="content-wrapper">
            <div class="container-fluid">
                <h1 class="mt-4" style="position: relative; top: -25px">权限管理</h1>
                <div class="row">
                    <div class="col-lg-6">
                        <div class="card mb-4" style="width: 1440px">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="id" DataSourceID="SqlDataSource1" BorderColor="#13619c" BorderStyle="Solid" BorderWidth="5px" CellPadding="4" CellSpacing="4" ForeColor="black" HorizontalAlign="Center" CssClass="auto-style1" Height="366px" Width="1141px" OnRowCommand="permission">
                                        <Columns>
                                            <asp:BoundField DataField="id" HeaderText="序号" InsertVisible="False" ReadOnly="True" SortExpression="id" />
                                            <asp:BoundField DataField="username" HeaderText="用户名" SortExpression="username" />
                                            <asp:BoundField DataField="reason" HeaderText="申请原因" SortExpression="reason" />
                                            <asp:BoundField DataField="status" HeaderText="申请状态" SortExpression="status" />

                                            <asp:ButtonField Text="给予发帖权限" HeaderText="给予发帖权限" CommandName="permission1" />
                                            <asp:ButtonField Text="取消发帖权限" HeaderText="取消发帖权限" CommandName="permission2" />
                                            <asp:CommandField HeaderText="删除" ShowDeleteButton="True" />
                                        </Columns>
                                    </asp:GridView>
                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Farmers_dbConnectionString %>" DeleteCommand="DELETE FROM [applyPost] WHERE [id] = @id" SelectCommand="SELECT * FROM [applyPost]">
                                        <DeleteParameters>
