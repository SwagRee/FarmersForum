<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Manager.master" AutoEventWireup="true" CodeFile="Admin_default_port.aspx.cs" Inherits="Aspx_Main_Admin_Admin_default_port" %>
    ...
    <body>
        ...
        <div class="content-wrapper">
            <div class="container-fluid">
                ...
                <asp:Button ID="btnAddNews" runat="server" Text="添加帖子" CssClass="btnAddPorts" OnClick="btnAddPost_Click" />
                        ...
                        <div class="card mb-4" style="width: 1440px">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Farmers_dbConnectionString %>" SelectCommand="SELECT * FROM [tiezi_info] WHERE ([publisher] = @publisher)" DeleteCommand="DELETE FROM [tiezi_info] WHERE [id] = @id" InsertCommand="INSERT INTO [tiezi_info] ([username], [password], [keys]) VALUES (@username, @password, @keys)" UpdateCommand="UPDATE [tiezi_info] SET [title] = @title, [tiezi_content] = @tiezi_content, [submitdate] = @submitdate WHERE [id] = @id">
                                        <SelectParameters>
