<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Manager.master" AutoEventWireup="true" CodeFile="AddNews.aspx.cs" Inherits="Aspx_Main_AddManager_AddNews" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <body>
        ...
        <div class="content-wrapper">
            <div class="container-fluid">
                <h1 class="mt-4" style="position: relative; top: -25px">添加新闻</h1>
                <div class="row">
                    <div class="col-lg-6">
