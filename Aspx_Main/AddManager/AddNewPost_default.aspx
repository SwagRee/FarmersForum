<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Manager.master" AutoEventWireup="true" CodeFile="AddNewPost_default.aspx.cs" Inherits="Aspx_Main_AddManager_AddNewPost_default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <body>
        ...
        <div class="content-wrapper">
            <div class="container-fluid">
                <h1 class="mt-4" style="position: relative; top: -25px">添加帖子</h1>
                <div class="row">
                    <div class="col-lg-6">
                        <div class="card mb-4" style="width: 1440px">
                                                                <div class="main">
                                        <p>
                                            发布标题：<asp:TextBox ID="txtTitle" runat="server" CssClass="borders"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="您还没有输入标题" ControlToValidate="txtTitle"></asp:RequiredFieldValidator>
                                        </p>
                                        <p>
                                            发布类别：<asp:DropDownList ID="DropDownList1" runat="server" CssClass="borders" ForeColor="#13619C ">
                                                <asp:ListItem Value="1">疑问探讨</asp:ListItem>
                                                <asp:ListItem Value="2">经验交流</asp:ListItem>
                                                <asp:ListItem Value="3">收获分享</asp:ListItem>
                                                <asp:ListItem Value="4">综合讨论</asp:ListItem>
                                            </asp:DropDownList>
                                        </p>
                                        <p>
                                            发布内容：<asp:TextBox ID="txtContent" runat="server" TextMode="MultiLine" Rows="4" CssClass="borders-rows"></asp:TextBox>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="您没有输入要上传的内容" ControlToValidate="txtContent"></asp:RequiredFieldValidator>
                                        </p>

                                        <p>
                                            <asp:Button ID="btnSubmit" runat="server" Text="提交" CssClass="btnborder" OnClick="btnClick"  />
